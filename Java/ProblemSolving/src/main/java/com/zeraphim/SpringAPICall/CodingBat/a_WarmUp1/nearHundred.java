...
public class nearHundred {
    ...
    public static boolean nearHundred(int n) {
        boolean isDistanceNearHundred = Math.abs(100 - n) <= 10;
        boolean isDistanceNearTwoHundred = Math.abs(200 - n) <= 10;

        return isDistanceNearHundred || isDistanceNearTwoHundred;
    }
}